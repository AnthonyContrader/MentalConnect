...
export class UtenteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.utenteService
      ...
      .subscribe(
        (res: HttpResponse<IUtente[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInUtentes(): void {
    this.eventSubscriber = this.eventManager.subscribe('utenteListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IUtente[] | null, headers: HttpHeaders, page: number): void {
