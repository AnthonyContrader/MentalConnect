...
public class GuideDAO
{
	...
	private final String QUERY_CREATE = "INSERT INTO guide (idGuide, question, answer) VALUES (?,?,?)";
	private final String QUERY_READ = "SELECT * FROM guide WHERE idGuide=?";
	private final String QUERY_UPDATE = "UPDATE guide SET question=?, answer=? WHERE idGuide=?";
