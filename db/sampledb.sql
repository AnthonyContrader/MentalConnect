...
INSERT INTO `Map` VALUES (1,1),(2,2);
...
INSERT INTO `Node` VALUES ('ciao',1,1),('pippo',2,2);
...
FOREIGN KEY (`idMap`) REFERENCES `Map`(`idMap`),
FOREIGN KEY (`idNode1`) REFERENCES `Node`(`idNode`),
FOREIGN KEY (`idNode2`) REFERENCES `Node`(`idNode`)
